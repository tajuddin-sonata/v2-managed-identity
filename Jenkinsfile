...
pipeline {
    ...
    parameters{
        ...
        string(name: 'AZURE_FUNCTION_NAME', defaultValue:'dev-wf-redact', description: '''The name of FunctionApp to deploy
            dev-wf-redact 
            stg-wf-redact
            prod-wf-redact''' )
                    ...
                    script {
                        sh """
                            ...
                            ${SONARQUBE_SCANNER_HOME}/bin/sonar-scanner \
                                -Dsonar.projectKey=My-Analyse_func \
                                -Dsonar.host.url=http://4.240.69.23:9000 \
                                -Dsonar.sources=src \
                                -Dsonar.sourceEncoding=UTF-8 \
                                -Dsonar.python.version=3.11
                                -Dsonar.login=sqp_f9651da222a3ba6fc320ff122ef305f859b1a00b
                        """
                    }
                }
            }
