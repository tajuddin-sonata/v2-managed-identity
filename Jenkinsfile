...
pipeline {
    ...
    parameters{
        ...
        string(name: 'AZURE_FUNCTION_APP_NAME', defaultValue:'dev-func-wfredact-sitl-eus', description: '''The name of FunctionApp to deploy
            dev-func-wfredact-cca-eus   for dev env.
            stg-func-wfredact-cca-eus   for staging env.
            prd-func-wfredact-cca-eus   for production env.
            ''' )
