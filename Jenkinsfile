...
pipeline {
    ...
    parameters{
        ...
        string(name: 'AZURE_FUNCTION_APP_NAME', defaultValue:'ssna-func-cca-dev-eus-wftranscode', description: '''The name of FunctionApp to deploy
            ssna-func-cca-dev-eus-wftranscode   for dev env.
            ssna-func-cca-stg-eus-wftranscode   for staging env.
            ssna-func-cca-prd-eus-wftranscode   for production env.
            ''' )
