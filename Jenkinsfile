...
pipeline {
    ...
    parameters{
        ...
        string(name: 'AZURE_FUNCTION_APP_NAME', defaultValue:'dev-func-wftranscode-sitl-eus', description: '''The name of FunctionApp to deploy
            dev-func-wftranscode-cca-eus   for dev env.
            stg-func-wftranscode-cca-eus   for staging env.
            prd-func-wftranscode-cca-eus   for production env.
            ''' )
